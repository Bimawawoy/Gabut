...
cetak(nel('[bold red]Masukan Link Video dari Tiktok',width=70,padding=(0,7)))
linkvidtt = input('>>> ')
...
try:
  with open('link.txt', "r") as linkvid:
    ...
    for i, line in enumerate(lines, start=2):  # Start from row 2
        ...
        cetak(nel('[bold yellow]Getting info...',width=70,padding=(0,7)))
  ...
  Console.print(nel('[bold green]Video tersimpan di storage/emulated/0/video'))
except KeyError:
